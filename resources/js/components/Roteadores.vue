          ...
          <template v-slot:rodape>
            <div class="row">
              <div class="col-10">
                <paginate-component>
                  <li
                    v-for="(l, key) in roteadores.links"
                    :key="key"
      ...
      <template v-slot:conteudo>
        ...
        <input-container-component titulo="Nome da antena">
          <input
            type="text"
            class="form-control"
            :value="$store.state.item.antena_id"
            disabled
          />
        </input-container-component>
        ...
        <input-container-component titulo="Data da nota">
          <input
            type="text"
            class="form-control"
            :value="$store.state.item.datanota"
            disabled
          />
        </input-container-component>
        ...
        <input-container-component titulo="Endereço MAC">
          <input
            type="text"
            class="form-control"
            :value="$store.state.item.macaddress"
            disabled
          />
        </input-container-component>
      ...
      axios
        ...
        .then((response) => {
          ...
          this.$store.state.transacao.mensagem =
            "Registro de roteador atualizado com sucesso!";
