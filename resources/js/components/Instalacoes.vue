<template>
            ...
            <div class="col-md-8">
                ...
                <card-component titulo="Busca de instalação">
                    <template v-slot:conteudo>
                        <div class="form-row">
                            ...
                            <div class="col mb-3">
                                <input-container-component titulo="Cidade da instalação" id="inputCidade"
                                    id-help="cidadeHelp" texto-ajuda=" Opcional. Informe a cidade da instalacao">
                                    <input type="text" class="form-control" id="inputCidade"
                                        aria-describedby="cidadeHelp" placeholder="Cidade da instalação"
                ...
                <card-component titulo="Relação de instalacões">
                    <template v-slot:conteudo>
                        ...
                        <table-component :dados="instalacaos.data" :visualizar="{
                            visivel: true,
                            dataToggle: 'modal',
    ...
    visivel: true,
    dataToggle: 'modal',
    dataTarget: '#modalInstalacaoAtualizar',
}" :remover="{
    visivel: true,
    dataToggle: 'modal',
    dataTarget: '#modalInstalacaoRemover',
}" :titulos="{
    ...
    //updated_at: { titulo: 'Data da atualização', tipo: 'data' },
                    ...
                    <template v-slot:rodape>
                        <div class="row">
                            <div class="col-10">
                                <paginate-component>
                                    <li v-for="(l, key) in instalacaos.links" :key="key"
        ...
        <modal-component id="modalInstalacao" titulo="Adicionar instalação">
            <template v-slot:alertas>
                ...
                <alert-component tipo="danger" :detalhes="transacaoDetalhes"
                    titulo="Erro ao tentar cadastrar a instalacao" v-if="transacaoStatus == 'erro'"></alert-component>
            </template>

            <template v-slot:conteudo>
                <!-- <div class="form-group">
                    <input-container-component titulo="" id="Instalacao" id-help="InstalacaoHelp" texto-ajuda=""> -->
                <!-- v-model: sincroniza com two-way-data binding -->
                <!--  <input type="text" class="form-control" id="Instalacao" aria-describedby="instalacaoHelp"
                            placeholder="Nome da instalação" v-model="instalacaos" />
                    </input-container-component>
                </div> -->

                <div class="form-group">
                    <input-container-component titulo="" id="cliente_id" id-help="cliente_idHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="cliente_id" aria-describedby="cliente_idHelp"
                            placeholder="Cliente" v-model="cliente_id" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="rua" id-help="ruaHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="rua" aria-describedby="ruaHelp" placeholder="Rua"
                            v-model="rua" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="numero" id-help="numeroHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="bairro" id-help="bairroHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="bairro" aria-describedby="bairroHelp"
                            placeholder="Bairro" v-model="bairro" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="cidade" id-help="cidadeHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="estado" id-help="estadoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="estado" aria-describedby="estadoHelp"
                            placeholder="Estado" v-model="estado" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="celular" id-help="celularHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="celular" aria-describedby="celularHelp"
                            placeholder="Celular" v-model="celular" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="telefone" id-help="telefoneHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="status" id-help="statusHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="status" aria-describedby="statusHelp"
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="" id-help="Help" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="instalador_id" aria-describedby="Help"
                            placeholder="Instalador" v-model="instalador_id" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="distribuidor_id" id-help="distribuidor_idHelp"
                        texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="distribuidor_id"
                            aria-describedby="distribuidor_idHelp" placeholder="Distribuidor"
                            v-model="distribuidor_id" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="plano_id" id-help="plano_idHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="plano_id" aria-describedby="plano_idHelp"
                            placeholder="Plano" v-model="plano_id" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="dataInstalacao" id-help="dataInstalacaoHelp"
                        texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="date" class="form-control" id="dataInstalacao"
                            aria-describedby="dataInstalacaoHelp" placeholder="Data Instalação"
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="dataDaNota" id-help="dataDaNotaHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="date" class="form-control" id="dataDaNota" aria-describedby="dataDaNotaHelp"
                            placeholder="Data da Nota" v-model="dataDaNota" />
                    </input-container-component>
                </div>
        ...
        <modal-component id="modalInstalacaoRemover" titulo="Remover instalação">
            ...
            <template v-slot:conteudo>
                ...
                <input-container-component titulo="Cidade">
                    <input type="text" class="form-control" :value="$store.state.item.cidade" disabled />
                </input-container-component>

                <input-container-component titulo="Estado">
                    <input type="text" class="form-control" :value="$store.state.item.estado" disabled />
                </input-container-component>
        ...
        <modal-component id="modalInstalacaoVisualizar" titulo="Visualizar antena">
            ...
            <template v-slot:conteudo>
                ...
                <input-container-component titulo="Rua">
                    <input type="text" class="form-control" :value="$store.state.item.rua" disabled />
                </input-container-component>

                <input-container-component titulo="Número">
                    <input type="text" class="form-control" :value="$store.state.item.numero" disabled />
                </input-container-component>

                <input-container-component titulo="Bairro">
                    <input type="text" class="form-control" :value="$store.state.item.bairro" disabled />
                </input-container-component>
                ...
                <input-container-component titulo="Instalador">
                    <input type="text" class="form-control" :value="$store.state.item.instalador_id" disabled />
                </input-container-component>

                <input-container-component titulo="Distribuidor">
                    <input type="text" class="form-control" :value="$store.state.item.distribuidor_id" disabled />
                </input-container-component>

                <input-container-component titulo="Plano">
                    <input type="text" class="form-control" :value="$store.state.item.plano_id" disabled />
                </input-container-component>

                <input-container-component titulo="Data instalação">
                    <input type="text" class="form-control" :value="$store.state.item.dataInstalacao" disabled />
                </input-container-component>
                ...
                <input-container-component titulo="Data da nota">
                    <input type="text" class="form-control" :value="$store.state.item.dataDaNota" disabled />
                </input-container-component>
            ...
            <template v-slot:conteudo>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="cliente_id" id-help="cliente_idHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="cliente_id" aria-describedby="cliente_idHelp"
                            placeholder="Cliente" v-model="$store.state.item.cliente_id" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="numero" id-help="numeroHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="numero" aria-describedby="numeroHelp"
                            placeholder="Número" v-model="$store.state.item.numero" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="bairro" id-help="bairroHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="bairro" aria-describedby="bairroHelp"
                            placeholder="Bairro" v-model="$store.state.item.bairro" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="cidade" id-help="cidadeHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="cidade" aria-describedby="cidadeHelp"
                            placeholder="Cidade" v-model="$store.state.item.cidade" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="estado" id-help="estadoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="estado" aria-describedby="estadoHelp"
                            placeholder="Estado" v-model="$store.state.item.estado" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="celular" id-help="celularHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="celular" aria-describedby="celularHelp"
                            placeholder="Celular" v-model="$store.state.item.celular" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="telefone" id-help="telefoneHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="telefone" aria-describedby="telefoneHelp"
                            placeholder="Telefone" v-model="$store.state.item.telefone" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="status" id-help="statusHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="status" aria-describedby="statusHelp"
                            placeholder="Status" v-model="$store.state.item.status" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="" id-help="Help" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="instalador_id" aria-describedby="Help"
                            placeholder="Instalador" v-model="$store.state.item.instalador_id" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="distribuidor_id" id-help="distribuidor_idHelp"
                        ...
                        <input type="text" class="form-control" id="distribuidor_id"
                            aria-describedby="distribuidor_idHelp" placeholder="Distribuidor"
                            v-model="$store.state.item.distribuidor_id" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="plano_id" id-help="plano_idHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="plano_id" aria-describedby="plano_idHelp"
                            placeholder="Plano" v-model="$store.state.item.plano_id" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="dataInstalacao" id-help="dataInstalacaoHelp"
                        ...
                        <input type="date" class="form-control" id="dataInstalacao"
                            aria-describedby="dataInstalacaoHelp" placeholder="Data Instalação"
                            v-model="$store.state.item.dataInstalacao" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="observacao" id-help="observacaoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="observacao" aria-describedby="observacaoHelp"
                            placeholder="Observação" v-model="$store.state.item.observacao" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="notaFiscal" id-help="notaFiscalHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="notaFiscal" aria-describedby="notaFiscalHelp"
                            placeholder="Nota Fiscal" v-model="$store.state.item.notaFiscal" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="dataDaNota" id-help="dataDaNotaHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="date" class="form-control" id="dataDaNota" aria-describedby="dataDaNotaHelp"
                            placeholder="Data da Nota" v-model="$store.state.item.dataDaNota" />
                    </input-container-component>
                </div>
