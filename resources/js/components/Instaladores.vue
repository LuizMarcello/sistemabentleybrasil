            ...
            <div class="col-md-8">
                ...
                <card-component titulo="Busca de instaladores">
                    <template v-slot:conteudo>
                        <div class="form-row">
                            ...
                            <div class="col mb-3">
                                <input-container-component titulo="Nome do instalador" id="inputNome" id-help="nomeHelp"
                                    texto-ajuda=" Opcional. Informe o nome do instalador">
                                    <input type="text" class="form-control" id="inputNome" aria-describedby="nomeHelp"
                                        placeholder="Nome do instalador" v-model="busca.nome" />
                                </input-container-component>
                            </div>
                        </div>
                    </template>
                ...
                <card-component titulo="Relação de instaladores">
                    <template v-slot:conteudo>
                        ...
                        <table-component :dados="instaladores.data" :visualizar="{
                            visivel: true,
                            dataToggle: 'modal',
    ...
    //updated_at: { titulo: 'Data da atualização', tipo: 'data' },
                    ...
                    <template v-slot:rodape>
                        <div class="row">
                            <div class="col-10">
                                <paginate-component>
                                    <li v-for="(l, key) in instaladores.links" :key="key"
        ...
        <modal-component id="modalInstalador" titulo="Adicionar instalador">
            <template v-slot:alertas>
                ...
                <alert-component tipo="danger" :detalhes="transacaoDetalhes"
                    titulo="Erro ao tentar cadastrar a instalador" v-if="transacaoStatus == 'erro'"></alert-component>
            </template>

            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="" id="novoInstalador" id-help="novoInstaladorHelp"
                        texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="novoInstalador"
                            aria-describedby="novoInstaladorHelp" placeholder="Nome do Instalador"
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="dataNascimento" id-help="dataNascimentoHelp"
                        texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="date" class="form-control" id="dataNascimento"
                            aria-describedby="dataNascimentoHelp" placeholder="Data de Nascimento"
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="observacao" id-help="observacaoHelp" texto-ajuda="">
                        ...
                        <input type="text" class="form-control" id="observacao" aria-describedby="observacaoHelp"
                            placeholder="Observacões" v-model="observacao" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="rg" id-help="rgHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="rg" aria-describedby="rgHelp" placeholder="RG"
                            v-model="rg" />
                    </input-container-component>
                </div>
        ...
        <modal-component id="modalInstaladorVisualizar" titulo="Visualizar instalador">
            ...
            <template v-slot:conteudo>
                ...
                <input-container-component titulo="Data de nascimento">
                    <input type="text" class="form-control" :value="$store.state.item.dataNascimento" disabled />
                </input-container-component>
                ...
                <input-container-component titulo="RG">
                    <input type="text" class="form-control" :value="$store.state.item.rg" disabled />
                </input-container-component>
            ...
            <template v-slot:conteudo>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="observacao" id-help="observacaoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="observacao" aria-describedby="observacaoHelp"
                            placeholder="Observacões" v-model="$store.state.item.observacao" />
                    </input-container-component>
                </div>
        ...
        atualizar() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.$store.state.transacao.mensagem = 'Registro de antena atualizado com sucesso!';
