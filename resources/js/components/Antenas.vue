                ...
                <card-component titulo="Relação de antenas">
                    <template v-slot:conteudo>
                        ...
                        <table-component :dados="antenas.data" :visualizar="{
                            visivel: true, dataToggle: 'modal', dataTarget: '#modalAntenaVisualizar'
        ...
        <modal-component id="modalAntena" titulo="Adicionar antena">
            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="" id="novaAntena" id-help="novaAntenaHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="novaAntena" aria-describedby="novaAntenaHelp"
