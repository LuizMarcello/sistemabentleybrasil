                ...
                <card-component titulo="Busca de cliente">
                    <template v-slot:conteudo>
                        <div class="form-row">
                            ...
                            <div class="col mb-3">
                                <input-container-component titulo="Nome do cliente" id="inputNome" id-help="nomeHelp"
                                    texto-ajuda=" Opcional. Informe o nome do cliente">
                                    <input type="text" class="form-control" id="inputNome" aria-describedby="nomeHelp"
                                        placeholder="Nome do cliente" v-model="busca.nome_razaosocial" />
                                </input-container-component>
                            </div>
                        </div>
                    </template>
    ...
    //updated_at: { titulo: 'Data da atualização', tipo: 'data' },
        ...
        <modal-component id="modalCliente" titulo="Adicionar cliente">
            <template v-slot:alertas>
                ...
                <alert-component tipo="danger" :detalhes="transacaoDetalhes" titulo="Erro ao tentar cadastrar o cliente"
                    v-if="transacaoStatus == 'erro'"></alert-component>
            </template>

            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="" id="novoCliente" id-help="novoClienteHelp" texto-ajuda="">
                        ...
                        <input type="text" class="form-control" id="novoCliente" aria-describedby="novoClienteHelp"
                            placeholder="Nome" v-model="nome_razaosocial" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="ie_rg" id-help="ie_rgHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="ie_rg" aria-describedby="ie_rgHelp"
                            placeholder="IE ou RG" v-model="ie_rg" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="nome_contato" id-help="nome_contatoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="nome_contato" aria-describedby="nome_contatoHelp"
                            placeholder="Contato" v-model="nome_contato" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="telefone" id-help="telefoneHelp" texto-ajuda="">
                        ...
                        <input type="text" class="form-control" id="telefone" aria-describedby="telefoneHelp"
                            placeholder="Telefone fixo" v-model="telefone" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="email" id-help="emailHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="email" aria-describedby="emailHelp"
                            placeholder="Melhor email" v-model="email" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="chave" id-help="chaveHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="chave" aria-describedby="chaveHelp"
                            placeholder="Chave" v-model="chave" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="dataadesao" id-help="dataadesaoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="date" class="form-control" id="dataadesao" aria-describedby="dataadesaoHelp"
                            placeholder="Data da adesao" v-model="dataadesao" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="cep" id-help="cepHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="cep" aria-describedby="cepHelp" placeholder="Cep"
                            v-model="cep" />
                    </input-container-component>
                </div>
        ...
        <modal-component id="modalClienteVisualizar" titulo="Visualizar cliente">
            ...
            <template v-slot:conteudo>
                ...
                <input-container-component titulo="Nome/Razão social">
                    <input type="text" class="form-control" :value="$store.state.item.nome_razaosocial" disabled />
                </input-container-component>
                ...
                <input-container-component titulo="RG">
                    <input type="text" class="form-control" :value="$store.state.item.ie_rg" disabled />
                </input-container-component>

                <input-container-component titulo="Contato">
                    <input type="text" class="form-control" :value="$store.state.item.nome_contato" disabled />
                </input-container-component>
                ...
                <input-container-component titulo="Chave">
                    <input type="text" class="form-control" :value="$store.state.item.chave" disabled />
                </input-container-component>

                <input-container-component titulo="Data adesão">
                    <input type="text" class="form-control" :value="$store.state.item.dataadesao" disabled />
                </input-container-component>
                ...
                <input-container-component titulo="CEP">
                    <input type="text" class="form-control" :value="$store.state.item.cep" disabled />
                </input-container-component>
            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="" id="novoCliente" id-help="novoClienteHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="novoCliente" aria-describedby="novoClienteHelp"
                            placeholder="Nome" v-model="$store.state.item.nome_razaosocial" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="ie_rg" id-help="ie_rgHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="ie_rg" aria-describedby="ie_rgHelp"
                            placeholder="IE ou RG" v-model="$store.state.item.ie_rg" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="nome_contato" id-help="nome_contatoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="nome_contato" aria-describedby="nome_contatoHelp"
                            placeholder="Contato" v-model="$store.state.item.nome_contato" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="telefone" id-help="telefoneHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="telefone" aria-describedby="telefoneHelp"
                            placeholder="Telefone fixo" v-model="$store.state.item.telefone" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="email" id-help="emailHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="email" aria-describedby="emailHelp"
                            placeholder="Melhor email" v-model="$store.state.item.email" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="chave" id-help="chaveHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="chave" aria-describedby="chaveHelp"
                            placeholder="Chave" v-model="$store.state.item.chave" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="dataadesao" id-help="dataadesaoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="date" class="form-control" id="dataadesao" aria-describedby="dataadesaoHelp"
                            placeholder="Data da adesao" v-model="$store.state.item.dataadesao" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="observacao" id-help="observacaoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="observacao" aria-describedby="observacaoHelp"
                            placeholder="Observacao" v-model="$store.state.item.observacao" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="situacao" id-help="situacaoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="situacao" aria-describedby="situacaoHelp"
                            placeholder="Situacao" v-model="$store.state.item.situacao" />
                    </input-container-component>
                </div>
