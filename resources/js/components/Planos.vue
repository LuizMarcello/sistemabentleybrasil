            ...
            <div class="col-md-8">
                ...
                <card-component titulo="Busca de planos">
                    <template v-slot:conteudo>
                        <div class="form-row">
                            ...
                            <div class="col mb-3">
                                <input-container-component titulo="Nome do plano" id="inputNome" id-help="nomeHelp"
                                    texto-ajuda=" Opcional. Informe o nome do plano">
                                    <input type="text" class="form-control" id="inputNome" aria-describedby="nomeHelp"
                                        placeholder="Nome do plano" v-model="busca.nome" />
                                </input-container-component>
                            </div>
                        </div>
                    </template>
                ...
                <card-component titulo="Relação de planos">
                    <template v-slot:conteudo>
                        ...
                        <table-component :dados="planos.data" :visualizar="{
                            visivel: true,
                            dataToggle: 'modal',
    ...
    //updated_at: { titulo: 'Data da atualização', tipo: 'data' },
                    ...
                    <template v-slot:rodape>
                        <div class="row">
                            <div class="col-10">
                                <paginate-component>
                                    <li v-for="(l, key) in planos.links" :key="key"
        ...
        <modal-component id="modalPlano" titulo="Adicionar plano">
            <template v-slot:alertas>
                ...
                <alert-component tipo="danger" :detalhes="transacaoDetalhes" titulo="Erro ao tentar cadastrar o plano"
                    v-if="transacaoStatus == 'erro'"></alert-component>
            </template>

            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="" id="novoPlano" id-help="novoPlanoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="novoPlano" aria-describedby="novoPlanoHelp"
                            placeholder="Nome do plano" v-model="nomePlano" />
                    </input-container-component>
                    <!--  {{ nomePlano }} -->
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="cir" id-help="cirHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="cir" aria-describedby="cirHelp" placeholder="Cir"
                            v-model="cir" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="equipamento" id-help="equipamentoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="equipamento" aria-describedby="equipamentoHelp"
                            placeholder="Equipamento" v-model="equipamento" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="valor" id-help="valorHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="valordecusto" id-help="valordecustoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="valordecusto" aria-describedby="valordecustoHelp"
                            placeholder="Valor de Custo" v-model="valordecusto" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="valormensal" id-help="valormensalHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="valormensal" aria-describedby="valormensalHelp"
                            placeholder="Valor Mensal" v-model="valormensal" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="velocmaxdown" id-help="velocmaxdownHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="velocmaxdown" aria-describedby="velocmaxdownlHelp"
                            placeholder="Velocidade máxima de download" v-model="velocmaxdown" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="velocmaxup" id-help="velocmaxupHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="velocmaxup" aria-describedby="velocmaxupHelp"
                            placeholder="Velocidade máxima de upload" v-model="velocmaxup" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="velocmindown" id-help="velocmindownHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="velocmindown" aria-describedby="velocmindownHelp"
                            placeholder="Velocidade minima de download" v-model="velocmindown" />
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="" id="velocminup" id-help="velocminupHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="velocminup" aria-describedby="velocminupHelp"
                            placeholder="Velocidade minima de upload" v-model="velocminup" />
                    </input-container-component>
                </div>
            </template>
        ...
        <modal-component id="modalPlanoVisualizar" titulo="Visualizar plano">
            ...
            <template v-slot:conteudo>
                ...
                <input-container-component titulo="CIR">
                    <input type="text" class="form-control" :value="$store.state.item.cir" disabled />
                </input-container-component>

                <input-container-component titulo="Equipamento">
                    <input type="text" class="form-control" :value="$store.state.item.equipamento" disabled />
                </input-container-component>
                ...
                <input-container-component titulo="Valor de custo">
                    <input type="text" class="form-control" :value="$store.state.item.valordecusto" disabled />
                </input-container-component>

                <input-container-component titulo="Valor mensal">
                    <input type="text" class="form-control" :value="$store.state.item.valormensal" disabled />
                </input-container-component>

                <input-container-component titulo="Velocidade máxima download">
                    <input type="text" class="form-control" :value="$store.state.item.velocmaxdown" disabled />
                </input-container-component>

                <input-container-component titulo="Velocidade máxima upload">
                    <input type="text" class="form-control" :value="$store.state.item.velocmaxup" disabled />
                </input-container-component>

                <input-container-component titulo="Velocidade mínima download">
                    <input type="text" class="form-control" :value="$store.state.item.velocmindown" disabled />
                </input-container-component>

                <input-container-component titulo="Velocidade mínima upload">
                    <input type="text" class="form-control" :value="$store.state.item.velocminup" disabled />
                </input-container-component>
            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="" id="novoPlano" id-help="novoPlanoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="novoPlano" aria-describedby="novoPlanoHelp"
                            placeholder="Nome do plano" v-model="$store.state.item.nome" />
                    </input-container-component>
                    <!--  {{ nomePlano }} -->
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="equipamento" id-help="equipamentoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="equipamento" aria-describedby="equipamentoHelp"
                            placeholder="Equipamento" v-model="$store.state.item.equipamento" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="valor" id-help="valorHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="valor" aria-describedby="valorHelp"
                            placeholder="Valor" v-model="$store.state.item.valor" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="valordecusto" id-help="valordecustoHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="valordecusto" aria-describedby="valordecustoHelp"
                            placeholder="Valor de Custo" v-model="$store.state.item.valordecusto" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="valormensal" id-help="valormensalHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="valormensal" aria-describedby="valormensalHelp"
                            placeholder="Valor Mensal" v-model="$store.state.item.valormensal" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="velocmaxdown" id-help="velocmaxdownHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="velocmaxdown" aria-describedby="velocmaxdownlHelp"
                            placeholder="Velocidade máxima de download" v-model="$store.state.item.velocmaxdown" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="velocmaxup" id-help="velocmaxupHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="velocmaxup" aria-describedby="velocmaxupHelp"
                            placeholder="Velocidade máxima de upload" v-model="$store.state.item.velocmaxup" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="velocmindown" id-help="velocmindownHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="velocmindown" aria-describedby="velocmindownHelp"
                            placeholder="Velocidade minima de download" v-model="$store.state.item.velocmindown" />
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="" id="velocminup" id-help="velocminupHelp" texto-ajuda="">
                        <!-- v-model: sincroniza com two-way-data binding -->
                        <input type="text" class="form-control" id="velocminup" aria-describedby="velocminupHelp"
                            placeholder="Velocidade minima de upload" v-model="$store.state.item.velocminup" />
                    </input-container-component>
                </div>
                <!-- {{ $store.state.item }} -->
            </template>
        ...
        atualizar() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.$store.state.transacao.mensagem = 'Registro de plano atualizado com sucesso!';
